...
export default function AdminDemo() {
  ...
  const [agents,setAgents]=useState<Agent[]>([]); const [approvals,setApprovals]=useState<Approval[]>([]); const [audit,setAudit]=useState<AuditEvent[]>([]); const [schema,setSchema]=useState<string>("");
